...
{/* FORM */}
                    ...
                    <h1 className="font-medium mb-2 text-sm">User Name</h1>
                      <div className="border-[1px] py-3 w-[100%] rounded-xl flex  items-center justify-center  border-black">
                          <Person style={{ fontSize: "18px" }} className="mx-2"/>
                              <input type="text" placeholder="Enter your username" value={username} onChange={(e) => setUsername(e.target.value)} className=" w-full  outline-none mx-2 text-sm"/>
                      </div>
                  </div>
      {/* END USER NAME*/}
                    ...
                    <h1 className="font-medium mb-2 text-sm">Email</h1>
                      <div className="border-[1px] py-3 w-[100%] rounded-xl flex  items-center justify-center  border-black">
                          <Email style={{ fontSize: "18px" }} className="mx-2"/>
                              <input type="email" placeholder="Enter your email" value={email} onChange={(e) => setEmail(e.target.value)} className=" w-full  outline-none mx-2 text-sm"/>
                      </div>
                  </div>
      {/* END EMAIL */}
      ...
      {/* LOGIN */}
                  <div className="flex-col flex items-center justify-center">
                    <button
                      type="submit"
                      className="rounded-xl border-[#0a1d37] hover:border-[#ccccccc2]  w-[100%] border-[1px] p-3 bg-[#001e2b] text-white font-medium  hover:bg-[#f0f0f0c2] hover:text-[#001e2b] duration-500 md:mt-6 mt-5  text-sm "
                    >
                      Create an Account
                    </button>
