        ...
        {loading ? (
          ...
          <div>
            ...
            <div className=" bg-white">
              <h1 className="flex items-center justify-center text-[30px] md:min-h-[690px]  min-h-[200px] text-black font-medium ">
                No Products!!!
              </h1>
            </div>
            <Footer />
                  ...
                  <div className="text-sm overflow-y-auto md:h-[520px]">
                    {items.map((item, index) => {
                      return (
                        <div
                          key={index}
                          className="flex  md:mb-4 mb-3 mt-3 md:mt-0  bg-white rounded-xl md:p-3 shadow-md "
                        >
                    {/* IMG */}
                          <div>
                            <Link to={`/productsPage/${item.id}`}>
                              <img
                                className="md:p-1 p-2 md:w-[120px] w-[140px] object-cover "
                                src={item.img}
                                alt="img-products"
                              />
                            </Link>
                  ...
                  <div className="text-sm md:mt-0 mt-4 md:ml-2">
                    <div className=" p-4  rounded-xl bg-white shadow-md">
                      ...
                      <div className=" flex flex-col md:flex md:flex-row items-center justify-center">
                        <input
                          className="border-[1px] border-[#ccc] px-4 rounded p-2 outline-none m-2 w-[100%]"
                          type="text"
                    ...
                    <div className=" mt-4  p-4 text-sm rounded-xl bg-white shadow-md">
                      ...
                      <div className="flex flex-col text-center w-[100%] ">
                        <div className="my-2 md:m-2">
                          <select
                            className="outline-none border-[1px] border-[#ccc] rounded p-2 px-4 w-[100%]"
                      ...
                      <div className="flex flex-col md:flex md:flex-row items-center justify-center text-sm">
                        <input
                          className="border-[1px] px-4 rounded border-[#ccc] p-2 outline-none m-2 w-[100%]"
                          type="text"
                      ...
                      <div className="md:m-2 my-2 text-sm">
                        <select
                          className="outline-none border-[1px] border-[#ccc] rounded p-2 px-4 md:w-[48%] w-[100%]"
                          name=""
                          id=""
                        >
                      ...
                      <div className="flex flex-col justify-center mt-6 items-start text-sm font-medium ">
                        <span>
                          <input
                            ...
                            id=""
                          />
                          Call someone else to pick up the goods
                        </span>
                        <span>
                          <input
                            className="mr-3 my-3"
                            ...
                            id=""
                          />
                          Instructions for use, answer questions about the
                          product
                        </span>
                        <span>
                          <input
