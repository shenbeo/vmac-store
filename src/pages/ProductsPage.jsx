...
import { SearchOutlined, Star, StarOutline } from "@material-ui/icons";
...
{/*  */}
            ...
            <div className=" text-center my-10">
              {isCompleted ? (
                <button className="border-[1px] w-52 rounded text-sm px-2 py-2 border-[#001e2b]  hover:font-medium  bg-[#001e2b] hover:bg-transparent hover:text-black text-white duration-500">
                  End
                </button>
              ) : (
                <button
                  className="border-[1px] rounded text-sm px-2 py-2 border-[#001e2b]  hover:font-medium  bg-[#001e2b] hover:bg-transparent hover:text-black text-white duration-500 w-52"
                  onClick={loadMore}
                >
                  Load more
                </button>
