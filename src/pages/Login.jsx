        ...
        {loading ? (
          ...
          <div className="bg-[#1f1f1f7c] border-[#5c5c5c] w-full md:w-auto h-full md:h-auto md:border-2 md:p-8 p-2 md:rounded-3xl md:shadow-2xl text-sm">
            ...
            <Link to="/">
              <CloseOutlined
                style={{ fontSize: "20px" }}
                className="flex items-center justify-center bg-[#cccccc53]  cursor-pointer rounded-full"
              />
            </Link>
            {/* END LOSE */}
            ...
            <div className="md:flex  items-center justify-center ">
              ...
              <div className="md:pr-[100px] flex items-center justify-center">
                <img
                  className="md:w-[300px] w-[100px] object-cover"
                  src="https://cdn-icons-png.flaticon.com/512/8911/8911501.png"
                  alt=""
                />
              </div>
              {/* END IMG */}
              ...
              <div>
                <form onSubmit={login} className="">
                  <h1 className="md:text-[40px] text-xl text-center  font-bold">
                    Login
                  </h1>
                  {/* EMAIL */}
                  <div className="mt-4 flex-col flex">
                    ...
                    <div className="border-[1px] py-3 w-[100%] rounded-xl flex  items-center justify-center  border-[#5c5c5c]">
                      ...
                      <input
                        className=" bg-transparent w-full  outline-none mx-2 text-sm"
                        type="email"
                  ...
                  <div className="md:mt-3 mt-2 flex-col flex ">
                    ...
                    <div className="border-[1px] py-3 w-[100%] rounded-xl flex  items-center justify-center  border-[#5c5c5c]">
                      ...
                      <input
                        ...
                        className="w-full bg-transparent  outline-none mx-2 text-sm"
                      />
                    </div>
                  </div>
                  {/* END PASSWORD */}
                  ...
                  <div className="text-center text-sm">
                    <button
                      type="submit"
                      className="rounded-xl border-[#0a1d37] hover:border-[#5c5c5c]  w-[100%] border-[1px] p-3 bg-[#001e2b] text-white font-medium  hover:bg-[#5c5c5c] hover:text-[#001e2b] duration-500 md:mt-6 mt-5  text-sm"
                    >
                      Login
                    </button>
                    <p className="mt-3">
