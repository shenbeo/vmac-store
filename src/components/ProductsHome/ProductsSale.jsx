        ...
        >
          {products.map((prosale, index) => {
            return (
              <div
                key={index}
                className="overflow-hidden relative border-[1px] rounded-xl border_sh  hover:border-[#001e2b] duration-700 cursor-pointer shadow-xl hover:shadow-2xl px-2 pt-4 md:pb-1 pb-4"
              >
                <Link
                  to={`/productsHome/${prosale.id}`}
